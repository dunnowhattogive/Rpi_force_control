...
class App:
    ...
    def toggle_fullscreen(self, event=None):
        ...
        if not current_state:
            ...
            # Exiting fullscreen
            self.root.state('normal')
            self.root.geometry("1200x800+100+100")  # Windowed size

    def update_force_and_thresh(self):
        """Periodically update force and threshold display"""
        # Read actual force data if hardware is connected
...
def run_system_tests(controller):
    ...
    try:
        ...
        controller.stepper_enabled = True  # Fixed: use stepper_enabled instead of enabled
